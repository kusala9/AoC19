...
//        pr();
    ...
    public static boolean dpr(BigInteger dir, String pad)
    {
        ...
        if (i>0)
        {
            ...
            System.out.println(pad.length() + " finished " + input1[0]  +  "-->" + i + "<--" + "(" + x + "," + y + ")" + " " + pos);
            return true; // finished....
        }
        else //hit a wall.
        {
            System.out.println(pad + "Hit a Wall...");
            // mark wall on screen...
            switch (dir.intValue())
            {
    ...
    public static void pr()
    {
        int px=80;
        int py=30;
        for (int r=yoff+py;r>=yoff+0;r--)
        {
            for (int c=xoff+0-20;c<xoff+px;c++)
            {
                if (been[c][r] == 1) System.out.print('O');
                else if (screen[c][r]==1) System.out.print("#");
